...
_files2db_ is a python tool to help anyone concatenate, normalize and check a multitude of flat plain files (`.csv`, `.xlsx`) into a single, standardized database.
